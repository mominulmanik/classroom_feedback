...
$servername = "localhost";
  ...
  if($num > 0){
$sql1="Select * from admin_student";
...
{
$sq="INSERT INTO `student` (`name`, `department`, `id_no`, `email`, `password`) VALUES ('$name', '$dept', '$id', '$email', '$pass')";
      $a=$con->query($sq);
      if($a)
        echo "OK";
      else echo "error";

      $s="DELETE FROM `admin_student` WHERE `id_no`='$id'";
      $b=$con->query($s);
...
?>
         ...
         <p>
         <?php  echo $ro['name'] ." student of department of ".$ro['department'] ?>
         </p>
         <p>
